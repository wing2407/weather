...
public class Utility {
	...
	/*
	 * json格式为 {"desc":"OK","status":1000,"data":{"wendu":"30","ganmao":
	 * "各项气象条件适宜，发生感冒机率较低。但请避免长期处于空调房间中，以防感冒。",
	 * "forecast":[{"fengxiang":"无持续风向",
	 * "fengli":"微风级","high":"高温 32℃","type":"多云"
	 * ,"low":"低温 28℃","date":"9日星期二"},
	 * {"fengxiang":"无持续风向","fengli":"微风级","high"
	 * :"高温 32℃","type":"多云","low":"低温 28℃","date":"10日星期三"},
	 * {"fengxiang":"无持续风向"
	 * ,"fengli":"微风级","high":"高温 32℃","type":"雷阵雨","low":"低温 28℃"
	 * ,"date":"11日星期四"},
	 * {"fengxiang":"无持续风向","fengli":"微风级","high":"高温 32℃","type"
	 * :"雷阵雨","low":"低温 27℃","date":"12日星期五"},
	 * {"fengxiang":"无持续风向","fengli":"微风级"
	 * ,"high":"高温 31℃","type":"雷阵雨","low":"低温 27℃","date":"13日星期六"}],
	 * "yesterday"
	 * :{"fl":"微风","fx":"无持续风向","high":"高温 32℃","type":"多云","low":"低温 28℃"
	 * ,"date":"8日星期一"},"city":"香港"}}
	 */
	...
	public static void handleWeatherResponse(Context context, String response) {
		try {
			...
			editor.putString("date", jsonObject2.getString("date"));
			...
			for (int i = 0; i < jsonArray.length(); ++i) {
				...
				// .replaceAll("[\u4e00-\u9fa5]+", "")方法是去掉字符串中的汉字
				editor.putString("high" + i, item.getString("high").replaceAll("[\u4e00-\u9fa5]+", ""));
				editor.putString("type" + i, item.getString("type"));
				editor.putString("low" + i, item.getString("low").replaceAll("[\u4e00-\u9fa5]+", ""));
